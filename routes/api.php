...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::post('/blogs/list', 'BlogsController@list');
    Route::get('/blogs/detail/{post_id}', 'BlogsController@detail');
    ...
    Route::group(['middleware' => 'admin'], function ($router) {
        ...
        Route::post('/posts/list', 'PostsController@list');
        Route::post('/posts/add', 'PostsController@add');
        Route::post('/posts/update/{post_id}', 'PostsController@update');
        Route::get('/posts/detail/{post_id}', 'PostsController@detail');
        Route::get('/posts/delete/{post_id}', 'PostsController@delete');
        Route::post('/posts/active/{post_id}', 'PostsController@active');
    });
});
